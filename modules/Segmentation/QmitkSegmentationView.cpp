...
QmitkSegmentationView::QmitkSegmentationView(QWidget* parent)
	: m_Parent(parent)
  , m_Controls(nullptr)
...
void QmitkSegmentationView::SetDataStorage(mitk::StandaloneDataStorage::Pointer dataStorage)
{
...
mitk::StandaloneDataStorage::Pointer QmitkSegmentationView::GetDataStorage()
{
...
void QmitkSegmentationView::setupGUI(QWidget* parent)
{
